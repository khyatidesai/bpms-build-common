...
INTALIO_NUTSNBOLTS = [ "org.intalio.security:security-web-nutsNbolts:jar:#{INTALIO_SECURITY_VERSION}" ]
...
JAVAX_J2EE_MANAGEMENT = "org.apache.geronimo.specs:geronimo-j2ee-management_1.0_spec:jar:1.1"
...
SAXON = group(%w{ saxon saxon-dom saxon-xpath}, :under => "net.sf.saxon", :version => "8.7")  
...
XMLBEANS = ["org.apache.xmlbeans:xmlbeans:jar:2.4.0", "xmlbeans:xmlpublic:jar:2.3.0", "xmlbeans:xbean_xpath:jar:2.3.0"]
...
OPENJPA = "org.apache.openjpa:openjpa-all:jar:2.1.1"
...
SECURITY = group(%w{
           security-ws-client   security-web-nutsNbolts
           security-ws-common   security-api
           },:under=>"org.intalio.security", :version=>"#{INTALIO_SECURITY_VERSION}")
...
PXE = group(%w{
ode-axis2           ode-bpel-api  ode-bpel-api-jca      ode-bpel-compiler
ode-bpel-connector  ode-bpel-epr  ode-bpel-obj
ode-bpel-schemas    ode-jca-ra    ode-jca-server
ode-tools           ode-utils },
:under=>"com.intalio.bpms.pxe", :version=>"6.5.1")

INTALIO_SECURITY_WS_TOKEN_CLIENT = group(%w{ security-ws-client security-ws-common}, 
                                 :under => "org.intalio.security", :version => INTALIO_SECURITY_VERSION)

BPMS_COMMON = ["com.intalio.bpms.common:bpms-common:jar:1.1.0.003"]

CONSOLE = ["com.intalio.bpms.console-common:console-common-webapp:jar:6.5.0.02",
           "com.intalio.bpms.console-common:console-common-models:jar:6.5.0.02"]

TEMPO = group(%w{
           tempo-ui-fw      tempo-tms-common    tempo-tms-service
           tempo-tms-axis   tempo-tms-client    tempo-dao-nutsNbolts
           },:under=>"org.intalio.tempo", :version=>"6.5.0.004")
HIBERNATE = [
